 ...
 * @version      3.5.1
 */
(function(){(function(n,m,e){var u,w,x,p,l,h,v,r;h=/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent);x=/Chrome/.test(navigator.userAgent);r=/Chrome/.test(navigator.userAgent)&&/Google Inc/.test(navigator.vendor)||/Safari/.test(navigator.userAgent)&&/Apple Computer/.test(navigator.vendor);p=h&&/crios/i.test(navigator.userAgent);v=/iPhone|iPad|iPod/i.test(navigator.userAgent)&&!!navigator.userAgent.match(/Version\/[\d\.]+.*Safari/);l=-1!==navigator.appVersion.indexOf("MSIE")||
0<navigator.appVersion.indexOf("Trident/");w=null!=m.body.classList;(function(){var h,l,m,b,a;l=0;a=["ms","moz","webkit","o"];h=0;for(m=a.length;h<m;h++)b=a[h],e.requestAnimationFrame=e[b+"RequestAnimationFrame"],e.cancelAnimationFrame=e[b+"CancelAnimationFrame"]||e[b+"CancelRequestAnimationFrame"];e.requestAnimationFrame||(e.requestAnimationFrame=function(a,c){var d,b,g;d=(new Date).getTime();g=Math.max(0,16-(d-l));b=e.setTimeout(function(){a(d+g)},g);l=d+g;return b});if(!e.cancelAnimationFrame)return e.cancelAnimationFrame=
function(a){return clearTimeout(a)}});u=function(){function t(b){this.options=n.extend(!0,{},this.Defaults,b);this.scenes=[];this.initialize();this.scrollY=e.scrollY||e.pageYOffset;this.lastScrollY=-1;this.inputFocus=!1}var y,u;y=function(){function b(a,f,c,d,b,g,k){this.amend=r||l||h?60:0;this.element=a;this.aliases=f;this.type=a.getAttribute("data-type")||"html";"html"===this.type&&(this.holder=this.createHolder());this.direction="normal"===a.getAttribute("data-direction")||null==a.getAttribute("data-direction")?
1:-1;this.fade="true"===a.getAttribute("data-fade");this.blur="true"===a.getAttribute("data-blur");this.boundTo=m.querySelector(a.getAttribute("data-bound-to"));"media"===this.type&&(this.url=a.getAttribute("data-url"));this.responsive=this.getResponsiveOptions();this.element.style.position=!l&&!h||p?"absolute":"fixed";switch(this.type){case "media":null!=this.url&&(this.element.style["background-image"]="url("+this.url+")");break;case "html":l&&h&&(this.element.style["z-index"]=1)}this.refresh(c,
d,b,g,k)}b.prototype.refresh=function(a,f,c,d,b){this.speed=this.getOption("speed",a)||0;this.offset=this.getOption("offset",a)||0;!l&&!h||p||(this.element.style.position=b?"fixed":"absolute");switch(this.type){case "media":return this.offsetHeight=this.getMediaHeight(f,d,this.speed,this.direction),this.element.style.height=this.offsetHeight+"px";case "html":this.element.style.width=this.holder.offsetWidth+"px";this.offsetHeight=this.element.offsetHeight;this.holder.style.height=this.offsetHeight+
"px";if(!l&&!h||p)return this.element.style.left=0,this.element.style.top=0;if(b)return this.element.style.left=this.getOffset(this.holder).left+"px",this.element.style.top=this.getOffset(this.holder).top-c+"px",this.holder.style.position="static";this.element.style.left=0;this.element.style.top=0;return this.holder.style.position="relative";case "custom":return this.offsetHeight=this.element.offsetHeight}};b.prototype.createHolder=function(){var a;a=m.createElement("div");w?a.classList.add("rd-parallax-layer-holder"):
a.className="rd-parallax-layer-holder";this.element.parentNode.insertBefore(a,this.element);a.appendChild(this.element);if(!l&&!h||p)a.style.position="relative";return a};b.prototype.getOption=function(a,f){var c,d;for(c in this.responsive)c<=f&&(d=c);return this.responsive[d][a]};b.prototype.getResponsiveOptions=function(){var a,f,c,d,b,g,k,e,h;e={};k=[];f=[];d=this.aliases;for(c in d)a=d[c],k.push(c),f.push(a);c=d=0;for(b=k.length;d<b;c=++d)for(g=k[c],e[g]={};-1<=(a=c);)!e[g].speed&&(h=this.element.getAttribute("data"+
